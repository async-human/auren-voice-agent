...
TOOL_INSTRUCTIONS = (
    ...
    "For 'calendar today', call list_calendar_events with period=today and the user's "
    "timezone; do not approximate today as the next 24 hours. For the latest email, call "
