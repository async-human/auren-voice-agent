...
def upgrade() -> None:
    # Development historically used Base.metadata.create_all(), so local
    # databases can contain these tables without an Alembic version. Adopt
    # those tables instead of trying to recreate them.
